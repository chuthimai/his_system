...
export class Migration1762070824939 implements MigrationInterface {
  name = 'Migration1762070824939';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE \`assessment_results\` (\`identifier\` int NOT NULL AUTO_INCREMENT, \`value\` varchar(255) NOT NULL, \`assessment_item_identifier\` int NOT NULL, \`service_report_identifier\` int NOT NULL, PRIMARY KEY (\`identifier\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
      `CREATE TABLE \`diagnosis_reports\` (\`identifier\` int NOT NULL, \`severity\` varchar(255) NOT NULL DEFAULT '', \`conclusion\` varchar(255) NOT NULL DEFAULT '', PRIMARY KEY (\`identifier\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE \`imaging_reports\` (\`identifier\` int NOT NULL, \`focus\` varchar(255) NOT NULL DEFAULT '', \`interpretation\` varchar(255) NOT NULL DEFAULT '', PRIMARY KEY (\`identifier\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE \`laboratory_reports\` (\`identifier\` int NOT NULL, \`interpretation\` varchar(255) NOT NULL DEFAULT '', PRIMARY KEY (\`identifier\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
      `CREATE TABLE \`service_reports\` (\`identifier\` int NOT NULL AUTO_INCREMENT, \`category\` varchar(255) NOT NULL DEFAULT '', \`method\` varchar(255) NOT NULL DEFAULT '', \`status\` tinyint NOT NULL DEFAULT 0, \`effective_time\` date NOT NULL DEFAULT '1000-01-01', \`record_time\` datetime NOT NULL DEFAULT '1000-01-01 00:00:00', \`patient_record_identifier\` int NOT NULL, \`service_identifier\` int NOT NULL, \`performer_identifier\` int NULL, \`reporter_identifier\` int NULL, \`requester_identifier\` int NULL, PRIMARY KEY (\`identifier\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
      `CREATE TABLE \`patient_records\` (\`identifier\` int NOT NULL AUTO_INCREMENT, \`status\` tinyint NOT NULL DEFAULT 0, \`created_time\` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP, \`prescription_identifier\` int NULL, \`patient_identifier\` int NOT NULL, UNIQUE INDEX \`REL_45755bf358c122397004dfc714\` (\`prescription_identifier\`), PRIMARY KEY (\`identifier\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE \`staff_work_schedules\` (\`identifier\` int NOT NULL AUTO_INCREMENT, \`duty\` varchar(255) NOT NULL, \`active\` tinyint NOT NULL DEFAULT 1, \`work_schedule_identifier\` int NOT NULL, \`staff_identifier\` int NOT NULL, \`location_identifier\` int NOT NULL, PRIMARY KEY (\`identifier\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE \`appointments\` (\`identifier\` int NOT NULL AUTO_INCREMENT, \`status\` tinyint NOT NULL DEFAULT 1, \`reason\` varchar(255) NULL, \`cancellation_date\` varchar(255) NULL, \`work_schedule_identifier\` int NOT NULL, \`physician_identifier\` int NULL, \`user_identifier\` int NOT NULL, PRIMARY KEY (\`identifier\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE \`measurement_items\` DROP COLUMN \`minimum\``,
    );
    await queryRunner.query(
      `ALTER TABLE \`measurement_items\` ADD \`minimum\` varchar(255) CHARACTER SET "utf8mb4" COLLATE "utf8mb4_unicode_ci" NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE \`measurement_items\` DROP COLUMN \`maximum\``,
    );
    await queryRunner.query(
      `ALTER TABLE \`measurement_items\` ADD \`maximum\` varchar(255) CHARACTER SET "utf8mb4" COLLATE "utf8mb4_unicode_ci" NOT NULL`,
    );
