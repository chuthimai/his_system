...
export class Migration1762770718058 implements MigrationInterface {
  name = 'Migration1762770718058';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE \`patient_records\` DROP COLUMN \`export_file_name\``,
    );
    await queryRunner.query(
      `ALTER TABLE \`patient_records\` ADD \`export_file_name\` varchar(255) NOT NULL DEFAULT ''`,
    );
    await queryRunner.query(
      `ALTER TABLE \`patient_records\` ADD \`exportFileName\` varchar(255) NOT NULL DEFAULT ''`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE \`patient_records\` DROP COLUMN \`exportFileName\``,
    );
    await queryRunner.query(
      `ALTER TABLE \`patient_records\` DROP COLUMN \`export_file_name\``,
    );
