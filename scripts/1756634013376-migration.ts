...
export class Migration1756634013376 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE \`users\` (\`identifier\` int NOT NULL AUTO_INCREMENT, \`name\` varchar(255) NOT NULL, \`telecom\` varchar(255) NULL, \`email\` varchar(255) NULL, \`gender\` varchar(255) NOT NULL, \`birth_date\` date NOT NULL, \`photo\` varchar(255) NULL, \`password\` varchar(255) NOT NULL, \`role\` varchar(255) NOT NULL, \`health_insurance_identity\` int NOT NULL, UNIQUE INDEX \`REL_79a90b964e495a6de20d6c07da\` (\`health_insurance_identity\`), PRIMARY KEY (\`identifier\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
